class MediaHelper {
    ...
    static async requestCamera(requestType = this.MediaRequestType.AUDIO_AND_VIDEO, idealWidthPx = 640, idealHeightPx = 480 , idDevice = null) {
        const resolution = {
        ...
        if ( idDevice !== null ) {
            constraints.video.deviceId = { exact: idDevice };
        }
